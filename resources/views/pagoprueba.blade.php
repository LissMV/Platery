<x-app-layout>
    ...
    <head>
        ...
        <script>
            function agregarAlCarrito() {
                const nombre = "Hamburguesa Clásica";
                const precio = 3.25;
    ...
    <div class="container mx-auto p-6 flex flex-col md:flex-row mt-5">
        <div class="w-96 h-96 mt-20">
            <img src="{{ asset('images/hamburguesacampero.png') }}" alt="" class="w-full h-auto object-cover m-2"/>
        </div>
        ...
        <div class="container mx-auto p-6 max-w-md border border-gray-800 shadow-md rounded-md">
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-600">Ingredientes: <span class="font-semibold">pan de hamburguesa, pechuga de pollo, mayonesa, lechuga, rodajas de tomate y pepinillos.
                </span></p>
                <p class="text-gray-600">Existencia: <span class="font-semibold">15 unidades</span></p>
            </div>
